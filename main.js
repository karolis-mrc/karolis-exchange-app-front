...
const dataURL = "https://karolis-exchange-app-front.herokuapp.com/rates";
    ...
    currenciesList.insertAdjacentHTML(
        ...
        `<li class="currency ${currency.abbreviation === baseCurrency ? "base-currency" : ""}" id=${currency.abbreviation}>
            <img src=${currency.flagURL} class="flag">
                <div class="info">
                    <p class="input"><span class="currency-symbol">${currency.symbol}<input placeholder="0.0000" value=${inputValue}></span></p>
